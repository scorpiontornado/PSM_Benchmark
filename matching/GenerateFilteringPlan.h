...
public:
    ...
    static void generateCFLFilterPlan(const Graph *data_graph, UnitArgs* u_args);
    static void generateDPisoFilterPlan(const Graph *data_graph, const Graph *query_graph, TreeNode *&tree,
                                        VertexID *&order);
    static void generateDPisoFilterPlan(const Graph *data_graph, UnitArgs* unitArgs);
    static void generateCECIFilterPlan(const Graph *data_graph, const Graph *query_graph, TreeNode *&tree,
                                       VertexID *&order);
    static void generateCECIFilterPlan(const Graph *data_graph, UnitArgs* unitArgs);
private:
