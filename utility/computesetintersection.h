...
#if SI == 0
    static void ComputeUnionGallopingAVX2(const VertexID* larray, ui l_count,
                                       const VertexID* rarray, ui r_count,
                                       VertexID* cn, ui &cn_count);

    // static void ComputeCNMergeBasedAVX2(const VertexID* larray, ui l_count,
    //                                     const VertexID* rarray, ui r_count,
    //                                     VertexID* cn, ui &cn_count);
