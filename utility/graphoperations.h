...
public:
    ...
    static void bfsTraversalOrdered(const Graph *graph, VertexID root_vertex, TreeNode *&tree, VertexID *&bfs_order, ui* order);

    static void printBFSTree(TreeNode* tree, VertexID vertex_num);
